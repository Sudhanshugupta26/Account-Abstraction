...
import {ZkMinimalAccount, Transaction, MemoryTransactionHelper} from "../../src/zksync/ZkMinimalAccount.sol";
...
contract ZkMinimalAccountTest is Test {
    ...
    function _signTransaction(
        ...
        (v, r, s) = vm.sign(DEFAULT_ANVIL_KEY, unsignedTransactionHash);
    ...
    function _createUnsignedTransaction(
        ...
        return
            Transaction({
                ...
                gasLimit: 16777288,
                gasPerPubdataByteLimit: 16777288,
                maxFeePerGas: 16777288,
                maxPriorityFeePerGas: 16777288,
                paymaster: 0,
                nonce: nonce,
                value: value,
