...
contract ZkMinimalAccount is IAccount, Ownable {
     ...
     * @notice must validate the transaction (check the owner has signed the transaction)
    ...
    function _validateTransaction(
        ...
        //In foundry.toml: is-system = true ,and becasue of that some perticular functions like call(x,y,z) are treated as system calls
